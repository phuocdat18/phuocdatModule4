...
public class Customer {
    ...
    public Customer(String fullName, String email, String phone, String address, BigDecimal balance, Date created_at, long created_by, Date updated_at, long updated_by, boolean deleted) {
        this.fullName = fullName;;
        this.email = email;
        this.phone = phone;
        this.address = address;
...
//    @Override
//    public int hashCode() {
//        return Objects.hash(id, fullName, email, phone, address, balance, created_at, created_by, updated_at, updated_by, deleted);
//    }
